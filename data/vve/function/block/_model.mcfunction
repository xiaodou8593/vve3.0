...
execute store result storage vve:io result.a int 0.0001 run scoreboard players get a int
execute store result storage vve:io result.mass int 1 run scoreboard players get mass int
execute store result storage vve:io result.inertia int 0.0001 run scoreboard players get inertia int
...
execute store result storage vve:io result.angular_vec[0] double 0.0001 run scoreboard players get angular_x int
execute store result storage vve:io result.angular_vec[1] double 0.0001 run scoreboard players get angular_y int
execute store result storage vve:io result.angular_vec[2] double 0.0001 run scoreboard players get angular_z int
execute store result storage vve:io result.angular_len int 0.0001 run scoreboard players get angular_len int
