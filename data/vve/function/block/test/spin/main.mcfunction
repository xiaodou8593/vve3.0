...
execute if score temp_mod int matches 5 run scoreboard players operation couple_x int *= -1 int
execute if score temp_mod int matches 5 run scoreboard players operation couple_y int *= -1 int
execute if score temp_mod int matches 5 run scoreboard players operation couple_z int *= -1 int
