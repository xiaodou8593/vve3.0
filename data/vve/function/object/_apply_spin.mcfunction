...
scoreboard players operation theta int = couple_x int
execute if score couple_x int matches ..-1 run scoreboard players operation theta int *= -1 int
execute if score couple_y int matches 1.. run scoreboard players operation theta int += couple_y int
execute if score couple_y int matches ..-1 run scoreboard players operation theta int -= couple_y int
execute if score couple_z int matches 1.. run scoreboard players operation theta int += couple_z int
execute if score couple_z int matches ..-1 run scoreboard players operation theta int -= couple_z int
